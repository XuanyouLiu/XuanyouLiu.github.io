...
\basicInfo{
  {\color{NUPurple}\faMapMarker*} 伊利诺伊州-埃文斯顿 \quad
  {\color{NUPurple}\faPhone*} （+86）188-1952-9667 \quad
  {\color{NUPurple}\faEnvelope} \email{xuanyou@u.northwestern.edu} \quad
  {\color{NUPurple}\faGlobe} \homepage[xuanyouliu.com]{https://xuanyouliu.com}
}
...
机器人学硕士 \quad 导师：Mark Yim 教授 \quad GPA: 4.00/4.00
\begin{itemize}
...
\begin{itemize}
  ...
  \item 设计紧凑型 PCB 并使用 Free RTOS 实现高频生物阻抗传感的实时固件
\end{itemize}
